export function Hero() {
  return (
    ...
    <header className="layout border-b border-ink/10 pt-16 pb-10 md:pt-24 md:pb-14">
      ...
      <h1 className="font-sans text-4xl md:text-6xl font-semibold tracking-tight leading-[1.05]">
        The number geometry of LLMs,
        <br />
        <span className="text-accent">across scripts and models</span>
      </h1>
      ...
      <p className="mt-8 text-lg leading-relaxed text-ink-soft">
        ...
        modular circles at period 2, 5, 10, and 100. We re-test this
        ...
        didn't: how much of what we're measuring is the model, and how
